<script lang="ts">
  ...
  const socialLinks = [
    {
      name: "LinkedIn",
      url: "https://linkedin.com/in/marcellokabora",
      icon: "mdi:linkedin",
...
>
  ...
  <div class="container mx-auto max-w-6xl px-6 py-20 pt-32 w-full text-center">
    <div in:flyAnim={{ y: -16, duration: 500, delay: 150 }}>
      ...
      >
        <Icon icon="material-symbols:mail-outline" class="text-sm" />
        Get in Touch
      </span>
    </div>
    <h1
  ...
  <div class="mt-16">
    <div class="text-center mb-8">
      ...
      <p class="text-zinc-400 text-lg">
        View or download my complete professional experience
      </p>
    </div>

    <!-- CV Card with iframe -->
    <div
      class="bg-zinc-900/50 border border-zinc-800 rounded-2xl overflow-hidden backdrop-blur-sm"
    >
      <div
      ...
      <div class="relative bg-zinc-800/50">
        <iframe
          src="/Marcello Annicchiarico.pdf"
          title="Curriculum Vitae"
          class="w-full h-[800px] md:h-[1000px] border-0"
        ></iframe>
      </div>
    </div>
  </div>
