		...
		<div class="item" data-aos="fade-up" data-aos-duration="1000">
			...
			<div class="body">
				...
				{#if company.name === 'Eva Global'}
					...
					<p>
						<b>Technologies</b>: Angular, NX, Jira, Gitlab, AWS, GraphQL, Figma, Material, Chart,
						Potsman, Storybook
					</p>
				{:else if company.name === 'Linus'}
					<p>
						...
						access to high-quality investments whilst providing a best-in-class investing experience
						through our digital platform.
					</p>
					<p>
						I started work with the core of the team rebuilding the new UI and working on the new <a
							href="https://marcellokabora.com/project/linus">registration</a
						>, my next task was to build the template of the main
						<a href="//marcellokabora.com/project/linus-product" target="_blank">product</a>
						using Builder.io and React.js. and after I had rebuilt several landing pages for the
				...
				{:else if company.name === 'Buildingminds'}
					<p>
						...
						decision making on every level from a single building to the entire portfolio.
					</p>
					<p>
						The application is built in Angular and Microsoft services, I worked on the
						implementation of many features moving around different teams, focusing on different <a
				...
				{:else if company.name === 'Yukkalab'}
					<p>
						...
						news and displays different kinds of data visualization like the
					...
					<p>
						By measuring, the sentiment in the markets and have developed financial models based on
						them. These technologies often highlight the market mood before the stock exchanges
						follow a few weeks later. As a result, you receive concrete recommendations for losses
						due to loss-limiting signals and an investment rate. The latter allows you to decide
						individually in which market you are investing.
					</p>
					<p>
				...
				{:else if company.name === 'Smava'}
					<p>
						...
						Frontend Developer was fundamental for the creation of the new
						<a href="https://marcellokabora.com/project/smava-website">homepage</a>. My team was
						responsible for the conversion from the design to web application, my focus was mostly
				...
				{:else if company.name === 'Tang Lang'}
					...
					<p>
						My job as Full Stack Developer was building 6 website for different event in Europe with
						all similar design but with different colors and images. The form for sell the travel
						provide several statment like the age or number of customers, the date and the time of
						the travel, the position of the pickup and the payment offcourse.
					</p>
					<p>
						...
						<a href="https://marcellokabora.com/project/christmas">Christmas Markets</a>,
						<a href="https://marcellokabora.com/project/loretdemar">Loret De Mar</a>. I worked in
						Italy for the first 8 Months and the after 4 Months in remote from Berlin after i
				...
				{:else if company.name === 'Maggiolino'}
					<p>
						...
						Stack Developer and my job was build the new website from scratch using the latest technology
						and design available.
					</p>
					<p>
						For the frontend i use Bootstrap and the layout of google images for show the book
						without disable the scroll list. For the backend i use pure php connected with a MySql
						database, all the animation are in Jquery and the payment is connected with paypal.
					</p>
					<p>
						I worked with this company for 16 months updating the database and improving the design
				...
				{:else if company.name === 'Annunci Animali'}
					<p>
						...
						others animals. My position inside the company was as Frontend Designer where i designed
						the homepage and most of the landing page of the website.
					</p>
					<p>
						I worked for this company for more than one year and i also work on the advertising
				...
				{:else if company.name === 'Airesis'}
					<p>
						...
						My position inside the company was UI/UX Designer and i worked with them for 6 months. Currently
						my design is already part of the project and i hope the platform will be popular and help
						people around the world.
					</p>
					<p>
						I designed the menu interface and the homepage of the discussions testing different
						layout and colors trying to find the right way to show all the information necessary and
