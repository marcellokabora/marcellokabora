...
<Project {data}>
  <p>
    As a front-end developer I worked on the implementation of many features
    inside the application moving around different 4 teams and focusing on
    different topics. After one year I was promoted to UI leader and started
    working directly with the design team in order to ensure each new component
    was perfect for the next implementation. I also worked for the construction
    of the support portal that provides all the information of the application
    and the tickets/support connection.
  </p>
</Project>
